...
define process name=filereader,instances=1
{
  thread name=filereaderthread,memsize=10m,instances=$nthreads
  {
    ...
    flowop openfile name=openfile3,filesetname=bigfileset,fd=1
    	flowop mmap name=mmap2,filesetname=bigfileset,iosize=$iosize,fd=1
		flowop mmap_readwholefile name=mapreadwholefile1,fd=1,iosize=$iosize
   		flowop mmap_appendfilerand name=appendfilerand2,iosize=$meanappendsize,fd=1
    	flowop msync name=msync2,srcfd=1,fd=1,iosize=$iosize
    	flowop munmap name=munmap2,iosize=$iosize,fd=1
    flowop closefile name=closefile3,fd=1
    flowop openfile name=openfile4,filesetname=bigfileset,fd=1
    	flowop mmap name=mmap3,filesetname=bigfileset,iosize=$iosize,fd=1
	flowop mmap_readwholefile name=mapreadwholefile2,fd=1,iosize=$iosize
    	flowop munmap name=munmap3,iosize=$iosize,fd=1
