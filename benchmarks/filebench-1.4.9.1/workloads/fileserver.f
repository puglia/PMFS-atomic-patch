...
define process name=filereader,instances=1
{
  thread name=filereaderthread,memsize=10m,instances=$nthreads
  {
	...
	flowop writewholefile name=wrtfile2,srcfd=1,fd=1,iosize=$iosize
	flowop writewholefile name=wrtfile3,srcfd=1,fd=1,iosize=$iosize
	flowop writewholefile name=wrtfile4,srcfd=1,fd=1,iosize=$iosize
