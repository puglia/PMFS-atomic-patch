...
define process name=proxycache,instances=1
{
  thread name=proxycache,memsize=10m,instances=$nthreads
  {
    ...
    flowop createfile name=createfile1,filesetname=bigfileset,fd=1
   			flowop mmap name=mmap1,filesetname=bigfileset,iosize=$meaniosize,fd=1
    			flowop mmap_appendfilerand name=appendfilerand1,iosize=$meaniosize,fd=1
    			flowop msync name=msync1,srcfd=1,fd=1,iosize=$iosize
    			flowop munmap name=munmap1,iosize=$meaniosize,fd=1
