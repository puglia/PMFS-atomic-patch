...
extern int __pmfs_new_block(struct super_block *sb, unsigned long *blocknr,
	unsigned short btype, int zero, int lock);

extern int pmfs_new_block_alt(struct super_block *sb, unsigned long *blocknr,
	unsigned short btype, int zero);
extern void pmfs_free_block_alt(struct super_block *sb, unsigned long blocknr,
		      unsigned short btype);
...
extern int pmfs_alloc_blocks(pmfs_transaction_t *trans, struct inode *inode,
		unsigned long file_blocknr, unsigned int num, bool zero);
extern int pmfs_cow_block(pmfs_transaction_t *trans, struct super_block *sb,
