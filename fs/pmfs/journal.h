...
#define MIN_ATOMIC_BLOCKS 512
#define ATOMIC_OVERSUPPLY 128
...
extern int new_atm_mapping(struct inode *inode, long total_data);
...
extern int pmfs_add_block_to_free( pmfs_transaction_t *trans, unsigned long blk);
